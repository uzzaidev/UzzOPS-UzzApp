...
import { Home, FileText, Calendar, Users, AlertTriangle, BarChart3, Star, Spade, Network, ShieldCheck, ClipboardList, Settings, FolderOpen, TrendingUp, Megaphone, Building2 } from 'lucide-react';
