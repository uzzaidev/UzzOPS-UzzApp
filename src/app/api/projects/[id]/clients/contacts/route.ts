...
const createContactSchema = z.object({
  ...
  dashboard_exec: z.record(z.string(), z.unknown()).optional(),
  bant_scores: z.record(z.string(), z.unknown()).optional(),
  fit_scores: z.record(z.string(), z.unknown()).optional(),
  ...
  participants_json: z.record(z.string(), z.unknown()).optional(),
