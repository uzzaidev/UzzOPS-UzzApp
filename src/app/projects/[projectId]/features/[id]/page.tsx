...
import { EditFeatureModal } from '@/components/features/edit-feature-modal';
import { DeleteFeatureDialog } from '@/components/features/delete-feature-dialog';
import { FeatureKnowledgeSection } from '@/components/features/feature-knowledge-section';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {(feature as any).tasks && (feature as any).tasks.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>Subtasks ({(feature as any).tasks.length})</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-2">
                  {(feature as any).tasks.map((task: any) => (
