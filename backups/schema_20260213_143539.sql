...
\restrict 6uhh2x6iOfoCyk2qQJZsmh2CdatoBDgJN9EAsfb9HsalhZanRUlvkgtLfrrTZXy
...
--
-- Name: calculate_project_progress(uuid, uuid, text); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.calculate_project_progress(p_project_id uuid, p_tenant_id uuid, p_trigger_event text DEFAULT 'manual'::text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
...
ALTER FUNCTION public.calculate_project_progress(p_project_id uuid, p_tenant_id uuid, p_trigger_event text) OWNER TO postgres;
...
--
-- Name: clamp_numeric(numeric, numeric, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.clamp_numeric(p_value numeric, p_min numeric, p_max numeric) RETURNS numeric
...
ALTER FUNCTION public.clamp_numeric(p_value numeric, p_min numeric, p_max numeric) OWNER TO postgres;
...
--
-- Name: log_work_item_status_change(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.log_work_item_status_change() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
ALTER FUNCTION public.log_work_item_status_change() OWNER TO postgres;

--
-- Name: recalculate_project_progress_trigger(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.recalculate_project_progress_trigger() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
ALTER FUNCTION public.recalculate_project_progress_trigger() OWNER TO postgres;
...
--
-- Name: safe_pct(numeric, numeric); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.safe_pct(p_numerator numeric, p_denominator numeric) RETURNS numeric
    LANGUAGE sql IMMUTABLE
    AS $$
  SELECT CASE
...
ALTER FUNCTION public.safe_pct(p_numerator numeric, p_denominator numeric) OWNER TO postgres;
...
--
-- Name: set_project_progress_settings_updated_at(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.set_project_progress_settings_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at = now();
...
ALTER FUNCTION public.set_project_progress_settings_updated_at() OWNER TO postgres;
...
CREATE TABLE public.marketing_assets (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT marketing_assets_asset_type_check CHECK ((asset_type = ANY (ARRAY['image'::text, 'video'::text, 'carousel_slide'::text, 'caption'::text, 'copy'::text, 'audio'::text, 'reference'::text, 'document'::text]))),
    CONSTRAINT marketing_assets_caption_channel_check CHECK ((caption_channel = ANY (ARRAY['instagram'::text, 'linkedin'::text, 'site'::text, 'tiktok'::text, 'youtube'::text, 'whatsapp'::text])))
);
...
CREATE TABLE public.marketing_campaigns (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT marketing_campaigns_status_check CHECK ((status = ANY (ARRAY['active'::text, 'draft'::text, 'completed'::text, 'archived'::text])))
);
...
CREATE TABLE public.marketing_channels (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT marketing_channels_platform_check CHECK ((platform = ANY (ARRAY['instagram'::text, 'linkedin'::text, 'tiktok'::text, 'youtube'::text, 'site'::text, 'whatsapp'::text, 'other'::text])))
);
...
--
-- Name: marketing_content_pieces; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.marketing_content_pieces (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    project_id uuid,
    campaign_id uuid,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT marketing_content_pieces_content_type_check CHECK ((content_type = ANY (ARRAY['reels'::text, 'feed'::text, 'carrossel'::text, 'stories'::text, 'artigo'::text, 'video'::text]))),
    CONSTRAINT marketing_content_pieces_status_check CHECK ((status = ANY (ARRAY['idea'::text, 'briefing'::text, 'production'::text, 'review'::text, 'approved'::text, 'done'::text, 'archived'::text])))
);


ALTER TABLE public.marketing_content_pieces OWNER TO postgres;

--
-- Name: marketing_publications; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.marketing_publications (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT marketing_publications_channel_check CHECK ((channel = ANY (ARRAY['instagram'::text, 'linkedin'::text, 'site'::text, 'tiktok'::text, 'youtube'::text, 'whatsapp'::text]))),
    CONSTRAINT marketing_publications_status_check CHECK ((status = ANY (ARRAY['idea'::text, 'draft'::text, 'scheduled'::text, 'published'::text, 'cancelled'::text])))
);
...
--
-- Name: project_progress_settings; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.project_progress_settings (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    project_id uuid NOT NULL,
    formula_version text DEFAULT 'v1'::text NOT NULL,
    weight_delivery numeric(5,2) DEFAULT 40.00 NOT NULL,
    weight_quality numeric(5,2) DEFAULT 20.00 NOT NULL,
    weight_schedule numeric(5,2) DEFAULT 20.00 NOT NULL,
    weight_risk numeric(5,2) DEFAULT 10.00 NOT NULL,
    weight_capacity numeric(5,2) DEFAULT 10.00 NOT NULL,
    delivery_feature_weight numeric(5,2) DEFAULT 0.70 NOT NULL,
    delivery_bug_weight numeric(5,2) DEFAULT 0.30 NOT NULL,
    healthy_min numeric(5,2) DEFAULT 75.00 NOT NULL,
    attention_min numeric(5,2) DEFAULT 50.00 NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    risk_critical_threshold integer DEFAULT 80 NOT NULL,
    snapshot_cooldown_seconds integer DEFAULT 45 NOT NULL,
    CONSTRAINT chk_delivery_subweights CHECK (((delivery_feature_weight >= (0)::numeric) AND (delivery_bug_weight >= (0)::numeric))),
    CONSTRAINT chk_progress_weights_non_negative CHECK (((weight_delivery >= (0)::numeric) AND (weight_quality >= (0)::numeric) AND (weight_schedule >= (0)::numeric) AND (weight_risk >= (0)::numeric) AND (weight_capacity >= (0)::numeric))),
    CONSTRAINT project_progress_settings_risk_critical_threshold_check CHECK (((risk_critical_threshold >= 1) AND (risk_critical_threshold <= 125))),
    CONSTRAINT project_progress_settings_snapshot_cooldown_seconds_check CHECK (((snapshot_cooldown_seconds >= 0) AND (snapshot_cooldown_seconds <= 600)))
);


ALTER TABLE public.project_progress_settings OWNER TO postgres;

--
-- Name: COLUMN project_progress_settings.risk_critical_threshold; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.project_progress_settings.risk_critical_threshold IS 'Limiar GUT para risco critico no calculo de progresso';


--
-- Name: COLUMN project_progress_settings.snapshot_cooldown_seconds; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON COLUMN public.project_progress_settings.snapshot_cooldown_seconds IS 'Janela minima entre snapshots do mesmo projeto/evento para dedupe anti write storm';
...
CREATE TABLE public.project_progress_snapshots (
    ...
    trigger_event text DEFAULT 'manual'::text NOT NULL,
    features_total integer DEFAULT 0 NOT NULL,
    features_done integer DEFAULT 0 NOT NULL,
    bugs_total integer DEFAULT 0 NOT NULL,
    bugs_resolved integer DEFAULT 0 NOT NULL,
    ...
    sprints_completed_total integer DEFAULT 0 NOT NULL,
    sprints_on_time integer DEFAULT 0 NOT NULL,
    ...
    risks_critical_open integer DEFAULT 0 NOT NULL,
    risk_pct numeric(5,2),
    risk_adjusted_pct numeric(5,2),
    velocity_avg_last3 numeric(8,2),
    velocity_target numeric(8,2),
    velocity_trend text DEFAULT 'insufficient_data'::text NOT NULL,
    capacity_pct numeric(5,2),
    score_confidence numeric(5,2) DEFAULT 0 NOT NULL,
    insufficient_data_flags jsonb DEFAULT '{}'::jsonb NOT NULL,
    progress_score numeric(5,2),
    progress_label text DEFAULT 'insufficient_data'::text NOT NULL,
    created_by uuid,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
--
-- Name: marketing_assets marketing_assets_storage_path_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: marketing_content_pieces marketing_content_pieces_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_content_pieces
    ADD CONSTRAINT marketing_content_pieces_pkey PRIMARY KEY (id);


--
-- Name: marketing_publications marketing_publications_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: project_progress_settings project_progress_settings_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.project_progress_settings
    ADD CONSTRAINT project_progress_settings_pkey PRIMARY KEY (id);
...
--
-- Name: marketing_channels uq_marketing_channels_tenant_platform; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_channels
    ADD CONSTRAINT uq_marketing_channels_tenant_platform UNIQUE (tenant_id, platform);


--
-- Name: marketing_content_pieces uq_marketing_content_code_tenant; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_content_pieces
    ADD CONSTRAINT uq_marketing_content_code_tenant UNIQUE (tenant_id, code);


--
-- Name: project_progress_settings uq_project_progress_settings_project; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.project_progress_settings
    ADD CONSTRAINT uq_project_progress_settings_project UNIQUE (project_id);
...
--
-- Name: work_item_status_history work_item_status_history_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.work_item_status_history
    ADD CONSTRAINT work_item_status_history_pkey PRIMARY KEY (id);
...
--
-- Name: idx_marketing_assets_tenant_approved; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_marketing_assets_tenant_approved ON public.marketing_assets USING btree (tenant_id, is_approved, created_at DESC);


--
-- Name: idx_marketing_assets_tenant_content; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_marketing_assets_tenant_content ON public.marketing_assets USING btree (tenant_id, content_piece_id, asset_type, created_at DESC);


--
-- Name: idx_marketing_campaigns_tenant_project; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_marketing_campaigns_tenant_project ON public.marketing_campaigns USING btree (tenant_id, project_id, status);


--
-- Name: idx_marketing_content_tenant_project; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_marketing_content_tenant_project ON public.marketing_content_pieces USING btree (tenant_id, project_id, content_type, status);


--
-- Name: idx_marketing_publications_tenant_content; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_marketing_publications_tenant_content ON public.marketing_publications USING btree (tenant_id, content_piece_id);


--
-- Name: idx_marketing_publications_tenant_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_marketing_publications_tenant_date ON public.marketing_publications USING btree (tenant_id, scheduled_date);


--
-- Name: idx_marketing_publications_tenant_status_date; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_marketing_publications_tenant_status_date ON public.marketing_publications USING btree (tenant_id, status, scheduled_date);
...
--
-- Name: idx_pps_project_time; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_pps_project_time ON public.project_progress_snapshots USING btree (project_id, snapshot_at DESC);


--
-- Name: idx_pps_tenant_time; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_pps_tenant_time ON public.project_progress_snapshots USING btree (tenant_id, snapshot_at DESC);
...
--
-- Name: idx_progress_settings_tenant; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_progress_settings_tenant ON public.project_progress_settings USING btree (tenant_id);
...
--
-- Name: idx_wish_feature_changed_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_wish_feature_changed_at ON public.work_item_status_history USING btree (feature_id, changed_at DESC);


--
-- Name: idx_wish_project_changed_at; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_wish_project_changed_at ON public.work_item_status_history USING btree (project_id, changed_at DESC);
...
--
-- Name: features trg_log_work_item_status_change; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_log_work_item_status_change AFTER INSERT OR UPDATE OF status ON public.features FOR EACH ROW EXECUTE FUNCTION public.log_work_item_status_change();


--
-- Name: marketing_assets trg_marketing_assets_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_marketing_assets_updated_at BEFORE UPDATE ON public.marketing_assets FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: marketing_campaigns trg_marketing_campaigns_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_marketing_campaigns_updated_at BEFORE UPDATE ON public.marketing_campaigns FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: marketing_channels trg_marketing_channels_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_marketing_channels_updated_at BEFORE UPDATE ON public.marketing_channels FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: marketing_content_pieces trg_marketing_content_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_marketing_content_updated_at BEFORE UPDATE ON public.marketing_content_pieces FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: marketing_publications trg_marketing_publications_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_marketing_publications_updated_at BEFORE UPDATE ON public.marketing_publications FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();


--
-- Name: features trg_progress_recalc_features; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_progress_recalc_features AFTER INSERT OR DELETE OR UPDATE OF status, due_date, work_item_type, dod_functional, dod_tests, dod_code_review, dod_documentation, dod_deployed, dod_user_acceptance ON public.features FOR EACH ROW EXECUTE FUNCTION public.recalculate_project_progress_trigger();


--
-- Name: risks trg_progress_recalc_risks; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_progress_recalc_risks AFTER INSERT OR DELETE OR UPDATE OF status, gut_g, gut_u, gut_t ON public.risks FOR EACH ROW EXECUTE FUNCTION public.recalculate_project_progress_trigger();


--
-- Name: sprints trg_progress_recalc_sprints; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_progress_recalc_sprints AFTER INSERT OR DELETE OR UPDATE OF status, completed_at, end_date, velocity_actual, velocity_target ON public.sprints FOR EACH ROW EXECUTE FUNCTION public.recalculate_project_progress_trigger();


--
-- Name: project_progress_settings trg_project_progress_settings_updated_at; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER trg_project_progress_settings_updated_at BEFORE UPDATE ON public.project_progress_settings FOR EACH ROW EXECUTE FUNCTION public.set_project_progress_settings_updated_at();
...
--
-- Name: marketing_assets marketing_assets_content_piece_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_assets
    ADD CONSTRAINT marketing_assets_content_piece_id_fkey FOREIGN KEY (content_piece_id) REFERENCES public.marketing_content_pieces(id) ON DELETE SET NULL;


--
-- Name: marketing_assets marketing_assets_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: marketing_campaigns marketing_campaigns_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_campaigns
    ADD CONSTRAINT marketing_campaigns_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE SET NULL;


--
-- Name: marketing_campaigns marketing_campaigns_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: marketing_channels marketing_channels_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_channels
    ADD CONSTRAINT marketing_channels_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: marketing_content_pieces marketing_content_pieces_campaign_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_content_pieces
    ADD CONSTRAINT marketing_content_pieces_campaign_id_fkey FOREIGN KEY (campaign_id) REFERENCES public.marketing_campaigns(id) ON DELETE SET NULL;


--
-- Name: marketing_content_pieces marketing_content_pieces_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_content_pieces
    ADD CONSTRAINT marketing_content_pieces_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE SET NULL;


--
-- Name: marketing_content_pieces marketing_content_pieces_responsible_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_content_pieces
    ADD CONSTRAINT marketing_content_pieces_responsible_id_fkey FOREIGN KEY (responsible_id) REFERENCES public.team_members(id) ON DELETE SET NULL;


--
-- Name: marketing_content_pieces marketing_content_pieces_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_content_pieces
    ADD CONSTRAINT marketing_content_pieces_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;


--
-- Name: marketing_publications marketing_publications_channel_config_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_publications
    ADD CONSTRAINT marketing_publications_channel_config_id_fkey FOREIGN KEY (channel_config_id) REFERENCES public.marketing_channels(id) ON DELETE SET NULL;


--
-- Name: marketing_publications marketing_publications_content_piece_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_publications
    ADD CONSTRAINT marketing_publications_content_piece_id_fkey FOREIGN KEY (content_piece_id) REFERENCES public.marketing_content_pieces(id) ON DELETE CASCADE;


--
-- Name: marketing_publications marketing_publications_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.marketing_publications
    ADD CONSTRAINT marketing_publications_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: project_progress_settings project_progress_settings_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.project_progress_settings
    ADD CONSTRAINT project_progress_settings_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;


--
-- Name: project_progress_settings project_progress_settings_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.project_progress_settings
    ADD CONSTRAINT project_progress_settings_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.project_progress_snapshots
    ADD CONSTRAINT project_progress_snapshots_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;


--
-- Name: project_progress_snapshots project_progress_snapshots_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.project_progress_snapshots
    ADD CONSTRAINT project_progress_snapshots_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: work_item_status_history work_item_status_history_feature_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.work_item_status_history
    ADD CONSTRAINT work_item_status_history_feature_id_fkey FOREIGN KEY (feature_id) REFERENCES public.features(id) ON DELETE CASCADE;


--
-- Name: work_item_status_history work_item_status_history_project_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.work_item_status_history
    ADD CONSTRAINT work_item_status_history_project_id_fkey FOREIGN KEY (project_id) REFERENCES public.projects(id) ON DELETE CASCADE;


--
-- Name: work_item_status_history work_item_status_history_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.work_item_status_history
    ADD CONSTRAINT work_item_status_history_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: marketing_assets; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.marketing_assets ENABLE ROW LEVEL SECURITY;

--
-- Name: marketing_assets marketing_assets_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_assets_select ON public.marketing_assets FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: marketing_assets marketing_assets_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_assets_write ON public.marketing_assets TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text))))) WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));
...
--
-- Name: marketing_campaigns marketing_campaigns_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_campaigns_select ON public.marketing_campaigns FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: marketing_campaigns marketing_campaigns_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_campaigns_write ON public.marketing_campaigns TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text))))) WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));
...
--
-- Name: marketing_channels; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.marketing_channels ENABLE ROW LEVEL SECURITY;

--
-- Name: marketing_channels marketing_channels_admin_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_channels_admin_write ON public.marketing_channels TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text) AND (cm.role = 'admin'::text))))) WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text) AND (cm.role = 'admin'::text)))));


--
-- Name: marketing_channels marketing_channels_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_channels_select ON public.marketing_channels FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: marketing_content_pieces; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.marketing_content_pieces ENABLE ROW LEVEL SECURITY;

--
-- Name: marketing_content_pieces marketing_content_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_content_select ON public.marketing_content_pieces FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: marketing_content_pieces marketing_content_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_content_write ON public.marketing_content_pieces TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text))))) WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));
...
--
-- Name: marketing_publications; Type: ROW SECURITY; Schema: public; Owner: postgres
--

ALTER TABLE public.marketing_publications ENABLE ROW LEVEL SECURITY;

--
-- Name: marketing_publications marketing_publications_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_publications_select ON public.marketing_publications FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: marketing_publications marketing_publications_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY marketing_publications_write ON public.marketing_publications TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text))))) WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));
...
--
-- Name: project_progress_settings; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: project_progress_settings tenant_isolation_progress_settings_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_isolation_progress_settings_select ON public.project_progress_settings FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: project_progress_settings tenant_isolation_progress_settings_write; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_isolation_progress_settings_write ON public.project_progress_settings TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text) AND (cm.role = 'admin'::text))))) WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text) AND (cm.role = 'admin'::text)))));
...
--
-- Name: project_progress_snapshots tenant_isolation_progress_snapshots_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_isolation_progress_snapshots_insert ON public.project_progress_snapshots FOR INSERT TO authenticated WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: project_progress_snapshots tenant_isolation_progress_snapshots_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_isolation_progress_snapshots_select ON public.project_progress_snapshots FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));
...
--
-- Name: work_item_status_history tenant_isolation_work_item_history_insert; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_isolation_work_item_history_insert ON public.work_item_status_history FOR INSERT TO authenticated WITH CHECK ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));


--
-- Name: work_item_status_history tenant_isolation_work_item_history_select; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_isolation_work_item_history_select ON public.work_item_status_history FOR SELECT TO authenticated USING ((tenant_id IN ( SELECT cm.tenant_id
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text)))));
...
--
-- Name: work_item_status_history; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: objects marketing_assets_delete; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY marketing_assets_delete ON storage.objects FOR DELETE TO authenticated USING (((bucket_id = 'marketing-assets'::text) AND (EXISTS ( SELECT 1
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text) AND (objects.name ~~ (('tenant-'::text || (cm.tenant_id)::text) || '/%'::text)))))));


--
-- Name: objects marketing_assets_insert; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY marketing_assets_insert ON storage.objects FOR INSERT TO authenticated WITH CHECK (((bucket_id = 'marketing-assets'::text) AND (EXISTS ( SELECT 1
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text) AND (objects.name ~~ (('tenant-'::text || (cm.tenant_id)::text) || '/%'::text)))))));


--
-- Name: objects marketing_assets_select; Type: POLICY; Schema: storage; Owner: supabase_storage_admin
--

CREATE POLICY marketing_assets_select ON storage.objects FOR SELECT TO authenticated USING (((bucket_id = 'marketing-assets'::text) AND (EXISTS ( SELECT 1
   FROM public.company_members cm
  WHERE ((cm.user_id = auth.uid()) AND (cm.status = 'active'::text) AND (objects.name ~~ (('tenant-'::text || (cm.tenant_id)::text) || '/%'::text)))))));
...
--
-- Name: FUNCTION calculate_project_progress(p_project_id uuid, p_tenant_id uuid, p_trigger_event text); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.calculate_project_progress(p_project_id uuid, p_tenant_id uuid, p_trigger_event text) TO anon;
GRANT ALL ON FUNCTION public.calculate_project_progress(p_project_id uuid, p_tenant_id uuid, p_trigger_event text) TO authenticated;
GRANT ALL ON FUNCTION public.calculate_project_progress(p_project_id uuid, p_tenant_id uuid, p_trigger_event text) TO service_role;
...
--
-- Name: FUNCTION clamp_numeric(p_value numeric, p_min numeric, p_max numeric); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.clamp_numeric(p_value numeric, p_min numeric, p_max numeric) TO anon;
GRANT ALL ON FUNCTION public.clamp_numeric(p_value numeric, p_min numeric, p_max numeric) TO authenticated;
GRANT ALL ON FUNCTION public.clamp_numeric(p_value numeric, p_min numeric, p_max numeric) TO service_role;
...
--
-- Name: FUNCTION log_work_item_status_change(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.log_work_item_status_change() TO anon;
GRANT ALL ON FUNCTION public.log_work_item_status_change() TO authenticated;
GRANT ALL ON FUNCTION public.log_work_item_status_change() TO service_role;


--
-- Name: FUNCTION recalculate_project_progress_trigger(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.recalculate_project_progress_trigger() TO anon;
GRANT ALL ON FUNCTION public.recalculate_project_progress_trigger() TO authenticated;
GRANT ALL ON FUNCTION public.recalculate_project_progress_trigger() TO service_role;
...
--
-- Name: FUNCTION safe_pct(p_numerator numeric, p_denominator numeric); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.safe_pct(p_numerator numeric, p_denominator numeric) TO anon;
GRANT ALL ON FUNCTION public.safe_pct(p_numerator numeric, p_denominator numeric) TO authenticated;
GRANT ALL ON FUNCTION public.safe_pct(p_numerator numeric, p_denominator numeric) TO service_role;
...
--
-- Name: FUNCTION set_project_progress_settings_updated_at(); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.set_project_progress_settings_updated_at() TO anon;
GRANT ALL ON FUNCTION public.set_project_progress_settings_updated_at() TO authenticated;
GRANT ALL ON FUNCTION public.set_project_progress_settings_updated_at() TO service_role;
...
--
-- Name: TABLE marketing_assets; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.marketing_assets TO anon;
GRANT ALL ON TABLE public.marketing_assets TO service_role;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.marketing_assets TO authenticated;
...
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.marketing_campaigns TO authenticated;


--
-- Name: TABLE marketing_channels; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.marketing_channels TO anon;
GRANT ALL ON TABLE public.marketing_channels TO service_role;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.marketing_channels TO authenticated;


--
-- Name: TABLE marketing_content_pieces; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.marketing_content_pieces TO anon;
GRANT ALL ON TABLE public.marketing_content_pieces TO service_role;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.marketing_content_pieces TO authenticated;


--
-- Name: TABLE marketing_publications; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.marketing_publications TO anon;
GRANT ALL ON TABLE public.marketing_publications TO service_role;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.marketing_publications TO authenticated;
...
--
-- Name: TABLE project_progress_settings; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.project_progress_settings TO anon;
GRANT ALL ON TABLE public.project_progress_settings TO service_role;
GRANT SELECT,INSERT,DELETE,UPDATE ON TABLE public.project_progress_settings TO authenticated;
...
GRANT ALL ON TABLE public.project_progress_snapshots TO service_role;
...
--
-- Name: TABLE work_item_status_history; Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON TABLE public.work_item_status_history TO anon;
GRANT ALL ON TABLE public.work_item_status_history TO service_role;
...
\unrestrict 6uhh2x6iOfoCyk2qQJZsmh2CdatoBDgJN9EAsfb9HsalhZanRUlvkgtLfrrTZXy
